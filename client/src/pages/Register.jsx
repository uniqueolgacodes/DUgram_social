    ...
    <div className='bg-bgColor w-full h-[100vh] flex items-center justify-center p-6'>
        <div className='w-full md:w-2/3 h-fit lg:h-full 2xl:h-5/6 py-8 lg:py-0 flex flex-row-reverse bg-primary rounded-xl overflow-hidden shadow-xl'>
          ...
          <div className='w-full lg:w-1/2 h-full p-10 2xl:px-20 flex flex-col justify-center'>
            ...
            <p className='text-ascent-1 text-base font-semibold mb-0 mt-0'>
              Finally, a sign up!
            </p>
        
            <form className="py-8 flex flex-col gap-5 mt-0 pt-0" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className='w-full flex flex-col lg:flex-row gap-1 md:gap-2'>
                <TextInput 
                    ...
                    type='text'
                    styles='w-full'
                    register={register("firstName", {required: "Please, chief...First name?"})}
                ...
                <TextInput 
                    ...
                    type='text'
                    styles='w-full'
                    register={register("lastName", {required: "Uhm, chief? Last name?"})}
              ...
              <TextInput 
                ...
                styles="w-full" label="Email  Address" 
                type="email"
                register={
                  register("email", {
              ...
              {/* This is for our passwords and validation #olgacodes */}
              <div className='w-full flex flex-col lg:flex-row gap-1 md:gap-2'>
                  <TextInput 
                    name="password" placeholder="Password" 
                    styles="w-full" label="Password" 
                    type="password"
                    register={
                      register("password", {
                  ...
                  <TextInput 
                    name="password" placeholder="Password" 
                    styles="w-full" label="Confirm Password" 
                    type="password"
                    register={
                      register("cPassword", {
                        validate: (value) => {
            ...
            <p className='py-2 flex flex-col gap-2 items-center'>
